...
ROOT = Path.cwd()
OUTPUT_DIR = ROOT / "report_plots" / "output"
...
EXTENSION_ANALYSIS_FILES = {
    "52 ticks": ROOT / "results" / "analysis" / "extension" / "extension" / "secondary_metrics.md",
    "156 ticks": ROOT / "results" / "analysis" / "extension_156ticks" / "extension" / "secondary_metrics.md",
    "260 ticks": ROOT / "results" / "analysis" / "extension_260ticks" / "extension" / "secondary_metrics.md",
}

EXTENSION_DATA_DIRS = {
    "52 ticks": ROOT / "results" / "data" / "python_extension",
    "156 ticks": ROOT / "results" / "data" / "python_extension_156ticks",
    "260 ticks": ROOT / "results" / "data" / "python_extension_260ticks",
}
...
def read_all_replication_summaries() -> list[dict]:
    summary_dir = ROOT / "results" / "analysis" / "replication" / "comparison"
    rows: list[dict] = []
